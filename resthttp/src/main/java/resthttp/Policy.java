...
public class Policy {
    ...
    public static class ReturnXEntity {
         ...
         * monthlyReturn : -7.85
         */
        private double farReturn;
        private double weeklyReturn;
        private double dailyReturn;
        private double monthlyReturn;

        public void setFarReturn(double farReturn) {
            this.farReturn = farReturn;
        }

        public void setWeeklyReturn(double weeklyReturn) {
    ...
    public static class StocksEntity {
         ...
         * stopLossPrice : null
         * stockId : 000952
         * returns : {"farReturn":"-18.98","weeklyReturn":"-18.98","dailyReturn":"-18.98","monthlyReturn":"-18.98"}
         */
